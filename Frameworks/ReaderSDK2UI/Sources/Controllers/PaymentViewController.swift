...
public final class PaymentViewController: UIViewController {
    ...
    public init(parameters: PaymentParameters, paymentManager: PaymentManager, theme: Theme, delegate: PaymentManagerDelegate) {
...
extension PaymentViewController: PaymentManagerDelegate {
    public func paymentManager(_ paymentManager: PaymentManager, didStart payment: PaymentHandle) {
